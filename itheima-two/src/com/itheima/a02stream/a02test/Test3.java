...
public class Test3 {
    public static void main(String[] args) {
      ...
      */
        ...
        //1.创建男演员和女演员ArrayList集合,用于储存最开始的字符串
        ArrayList<String> actors = new ArrayList<>();
        ArrayList<String> actresses = new ArrayList<>();

        //2.添加信息
        Collections.addAll(actors, "蔡坤坤,24", "叶齁咸,23", "刘不甜,22", "吴签,24", "谷嘉,30", "肖梁梁,27");
        Collections.addAll(actresses, "赵小颖,35", "杨颖,36", "高元元,43", "张天天,31", "刘诗,35", "杨小幂,33");
        ...
        //4.女演员只要姓杨的，并且不要第一个
        Stream<String> stream2 = actresses.stream()
